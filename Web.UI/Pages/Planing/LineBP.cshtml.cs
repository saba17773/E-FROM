...
{
    public class LineBPModel : PageModel
    {
        ...
        public void OnGet(int year, int month, int version, int type)
        {
            Year = year;
            Month = month;
            VersionId = version;
        ...
        public async Task<IActionResult> OnPostGridAsync(int year, int version, int type)
        {
            try
            {
