...
{
    public class MarketForecastItemModel : PageModel
    {
        [TempData]
        ...
        public MarketForecastItemModel(
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                var filePath = "";
                var rootPathUpload = "wwwroot/files/import/market_forecast_item";
                ...
                {
                    HeaderRow = true
                }.Fetch<ImportTemplateMarketForecastItemExcelModel>(0);
                ...
                using (var unitOfWork = new UnitOfWork(_databaseContext.GetConnection("Import")))
                {
                    ...
                    var doCompanyList = t.Connection.Query<ClearOldDataParamsModel>(@"
                        ...
                        FROM TB_ImportTemplateMarketForecastItem
                    ...
                    foreach (var item in doCompanyList)
                    {
                        ...
                        @"
                            DELETE FROM TB_ImportTemplateMarketForecastItem
                    ...
                    {
                        await t.Connection.InsertAsync(new ImportTemplateMarketForecastItem
                        {
                            Year = item.Year,
                            Month = item.Month,
                    ...
                    return Redirect($"/Purchase/Import/MarketForecastItem");
                }
            }
            catch (Exception ex)
            {
