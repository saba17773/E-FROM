...
{
    public class MarketForecastSubgroupModel : PageModel
    {
        [TempData]
        ...
        public MarketForecastSubgroupModel(
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                var filePath = "";
                var rootPathUpload = "wwwroot/files/import/market_forecast_subgroup";
                ...
                {
                    HeaderRow = true
                }.Fetch<ImportTemplateMarketForecastSubGroupExcelModel>(0);
                ...
                using (var unitOfWork = new UnitOfWork(_databaseContext.GetConnection("Import")))
                {
                    ...
                    var doCompanyList = t.Connection.Query<ClearOldDataParamsModel>(@"
                        ...
                        FROM TB_ImportTemplateMarketForecastSubGroup
                    ...
                    foreach (var item in doCompanyList)
                    {
                        ...
                        @"
                            DELETE FROM TB_ImportTemplateMarketForecastSubGroup
                    ...
                    {
                        await t.Connection.InsertAsync(new ImportTemplateMarketForecastSubGroup
                        {
                            Year = item.Year,
                            Month = item.Month,
                    ...
                    return Redirect($"/Purchase/Import/MarketForecastSubgroup");
                }
            }
            catch (Exception ex)
            {
