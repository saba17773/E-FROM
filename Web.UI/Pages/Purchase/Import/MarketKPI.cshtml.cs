...
{
    public class MarketKPIModel : PageModel
    {
        [TempData]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            try
            {
                ...
                var filePath = "";
                var rootPathUpload = "wwwroot/files/import/market_kpi";
                ...
                {
                    HeaderRow = true
                }.Fetch<ImportTemplateMarketKPIExcelModel>(0);
                ...
                using (var unitOfWork = new UnitOfWork(_databaseContext.GetConnection("Import")))
                {
                    ...
                    var doCompanyList = t.Connection.Query<ClearOldDataParamsModel>(@"
                        ...
                        FROM TB_ImportTemplateMarketKPI
                    ...
                    foreach (var item in doCompanyList)
                    {
                        ...
                        @"
                            DELETE FROM TB_ImportTemplateMarketKPI
                    ...
                    {
                        await t.Connection.InsertAsync(new ImportTemplateMarketKPI
                        {
                            Year = item.Year,
                    ...
                    return Redirect($"/Purchase/Import/MarketKPI");
                }
