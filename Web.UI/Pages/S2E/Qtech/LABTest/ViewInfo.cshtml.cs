    ...
    public class ViewInfoModel : PageModel
    {
        ...
        public async Task GetData(int LABID, int LABLINEID)
        {
            using (var unitOfWork = new UnitOfWork(_databaseContext.GetConnection()))
            {
                ...
                if (await _authService.CanDisplay(nameof(S2EPermissionModel.VIEW_QTECH)))
                {
                    isPurchase = 0;
                }
                else
                ...
                if (isPurchase == 0)
                {
                    if (LABTestLineByID.APPROVESTATUS == 5 || LABTestLineByID.APPROVESTATUS == 7)
                    {
                        PageBack = "/S2E/Qtech/LABTest/MainSuccess";
                        
                    }
                    else if (LABTestLineByID.APPROVESTATUS == 2)
                    {
                        PageBack = "/S2E/Qtech/LABTest/MainCancel";
                    }
                    else
                    {
                        PageBack = "/S2E/Qtech/LABTest/Main";
                    }
                ...
                {
                    if (LABTestLineByID.APPROVESTATUS == 2)
                    {
                        PageBack = "/S2E/Purchase/PurchaseSample/MainCancel";
                    }
                    else
                    {
                        PageBack = "/S2E/Purchase/PurchaseSample/Main";
                    }
