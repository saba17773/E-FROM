            ...
            try
            {
                ...
                using (var unitOfWork = new UnitOfWork(_databaseContext.GetConnection()))
                {
                                    ...
                                    if (NewRequestByID.ISCOMPAIRE == 1)
                                    {
                                        ...
                                        BodyEmail = $@"
                                            ...
                                            <table width='70%'>
                                             ...
                                             <b>ผลการทดสอบ : </b> {Body}
                                             <br/><br/>
                                             <a href='{_configuration["Config:BaseUrl"]}/S2E/TrialTestViewInfo/?TRIALID={TRIALID}&TRIALLINEID={TRIALLINEID}&EMAILAPPROVE={emaillog.Email}'> คลิกที่นี่ เพื่อดูรายละเอียด </a>
                                        ";
                            ...
                            if (NewRequestByID.ISCOMPAIRE == 1) {
                                ...
                                BodyEmail = $@"
                                    ...
                                    <table width='70%'>
                                     ...
                                     <b>ผลการทดสอบ : </b> {Body}
                                    <br/><br/>
                                    <a href='{_configuration["Config:BaseUrl"]}/S2E/TrialTestViewInfo/?TRIALID={TRIALID}&TRIALLINEID={TRIALLINEID}&EMAILAPPROVE={UserALL.Email}'> คลิกที่นี่ เพื่อดูรายละเอียด </a>
                    ...
                    else if (ApproveResult == 2 && ApproveRemark != null)
                    {
                        ...
                        var sendEmail = _emailService.SendEmail(
                            $"{NewRequestByID.REQUESTCODE} / Reject / แจ้งผลการทดสอบวัตถุดิบ Trial / {Subject}",
                            BodyEmail,
                            EmailReject,
                            new List<string> { },
                            "",
                            ...
                            if (NewRequestByID.ISCOMPAIRE == 1)
                            {
                                ...
                                BodyEmail = $@"
                                    ...
                                    <table width='70%'>
                                     ...
                                     <b>ผลการทดสอบ : </b> {Body}
                                     <br/>
                                     <b>Link เพื่อดำเนินการ:</b> <a href='{_configuration["Config:BaseUrl"]}/S2E/Qtech/TRIALTestTodolist?Email={next.EMAIL}'> คลิกที่นี่ </a>
                                     <br/>
                                ";
                            }
                            else
