...
{
    public class ApproveVender_ReviseModel : PageModel
    {
        [TempData]
        ...
        public ApproveVender_ReviseModel(
        ...
        public async Task<IActionResult> OnPostAsync(int VendID, int TranID, string nonce, string email)
        {
            try
            {
                ...
                if (ApproveResult == 2 && ApproveRemark == null)
                {
                    ...
                    return Redirect($"/Vender/ApproveVender_Revise?VendID={VendID}&TranID={TranID}&nonce={nonce}&email={email}");
                }
                ...
                using (var unitOfWork = new UnitOfWork(_databaseContext.GetConnection()))
                {
                    ...
                    var approvemasterid = venderTable.APPROVEMASTERID;
                    ...
                    if (venderTable.CURRENTAPPROVESTEP == approveTransAll.ToList().Count && ApproveResult == 1)
                    {
                        ...
                        venderTable.PRODTYPEDETAIL = vendTbTemp.PRODTYPEDETAIL_TEMP;
                        ...
                        var sendCompleteEmail = _emailService.SendEmail(
                                 $"Subject : {venderTable.REQUESTCODE} / {venderTable.VENDCODE_AX} / ดำเนินการ Revise เรียบร้อยแล้ว",
                                $@"
                                     <b>ดำเนินการ Revise เรียบร้อยแล้ว</b> <br/><br/>
                    ...
                    else if (ApproveResult == 2 && ApproveRemark != null)
                    {
                        ...
                        var sendRejectEmail = _emailService.SendEmail(
                                $"Subject : {venderTable.REQUESTCODE} / Reject Revise / ร้องขอเพื่อแก้ไขข้อมูลผู้ขาย {vendercode}",
                                $@"
                                    <b> ร้องขอเพื่อแก้ไขข้อมูลผู้ขาย {vendercode} </b><br/>
                                    ...
                                    <br/><br/><br/>
                                    <b style='color:red'> สาเหตุการร้องขอ Revise </b> {vendTbTemp.REMARK_TEMP}<br/>
                                    <br/><br/><br/>
                    ...
                    else
                    {
                        ...
                        foreach (var i in nextLevel)
                        {
                            ...
                            var sendNextEmail = _emailService.SendEmail(
                                ...
                                ",
                                    //<b style='color:black'>Link เพื่อดำเนินการ:</b> <a href='{_configuration["Config:BaseUrl"]}/Vender/ApproveVender_Revise?VendID={VendID}&TranID={nextApproveTrans.ID}&nonce={nonceKey}'>คลิกที่นี่</a> <br/>
